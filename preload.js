...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  startQobuzSession: (payload = {}) => ipcRenderer.invoke("run-qobuz-scraper", { ...payload, mode: "qobuz-scrape" }),
  startDownloadNrSession: (payload = {}) => ipcRenderer.invoke("run-qobuz-scraper", { ...payload, mode: "download-nr" }),
  stopDownloadSession: (payload = {}) => ipcRenderer.invoke("stop-download-session", payload),
  cancelDownloadSession: (payload = {}) => ipcRenderer.invoke("cancel-download-session", payload),
  getDownloadSessionState: (payload = {}) => ipcRenderer.invoke("get-download-session-state", payload),
  ...
  fetchFilterShortcuts: (payload = {}) => ipcRenderer.invoke("fetch-filter-shortcuts", payload),
  saveFilterShortcut: (payload = {}) => ipcRenderer.invoke("save-filter-shortcut", payload),
  saveFilterShortcuts: (payload = {}) => ipcRenderer.invoke("save-filter-shortcuts", payload),
  ...
  onDownloadSessionEvent: (handler) => ipcRenderer.on("qobuz-scrape-progress", handler),
  removeDownloadSessionEvent: (handler) => ipcRenderer.removeListener("qobuz-scrape-progress", handler),
