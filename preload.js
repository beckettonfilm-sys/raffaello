...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  stopQobuzSession: (payload = {}) => ipcRenderer.invoke("qobuz-session-stop-and-save", payload),
  cancelQobuzSession: (payload = {}) => ipcRenderer.invoke("qobuz-session-cancel", payload),
  getQobuzSessionState: (payload = {}) => ipcRenderer.invoke("qobuz-session-state", payload),
